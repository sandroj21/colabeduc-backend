...
<html>
    ...
    <body>
        ...
        <div id="show-tarefa" class="content scaffold-show" role="main">
            ...
            <f:display bean="tarefa" />
            <g:form resource="${this.tarefa}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tarefa}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
