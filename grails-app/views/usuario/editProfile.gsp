        ...
        <div id="edit-usuario" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.usuario}" method="PUT">
                ...
                <fieldset class="form">
                    ...
                    <g:link class="edit" action="editProfileImage" resource="${this.usuario}"><g:message code="usuario.profileImageUrl.edit.label" default="Atualizar imagem do Perfil" /></g:link>
